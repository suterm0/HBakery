...
def cookies():
    for cookie in range(1, 7):
        sales = (input(f"What are the cookie sales for Month {cookie}? > "))
...
def candies():
    for candy in range(1, 7):
        sales2 = (input(f"What are the candy sales for Month {candy}? > "))
